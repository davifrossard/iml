...
def deepdream(net_layer, net_input, img, sess, n_it=10, step=1, n_oct=7, sc_oct=1.4):
...
if __name__ == "__main__":
    ...
    with sess.as_default():
        ...
        img = imread('trump.jpg', mode='RGB').astype('float32')
        img = deepdream(vgg.conv4_1, imgs, img, sess)
